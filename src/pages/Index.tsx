          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="https://www.linkedin.com/in/chaunguyen0691/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-transparent border-2 border-white hover:bg-white hover:text-blue-600 text-white font-semibold py-3 px-6 rounded-lg flex items-center gap-2 transition-colors"
                >
          ...
          <div className="text-center mb-12">
           ...
           <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Master of Science</h3>
              <p className="text-lg text-blue-600 font-semibold mb-2">Business Management Information System</p>
              <p className="text-gray-600 mb-2">University of Houston Clear Lake</p>
              <p className="text-sm text-gray-500">Jan 2016 - May 2018</p>
            </div>
          </div>
          <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-200 text-center">
              ...
              <p className="text-lg text-blue-600 font-semibold mb-2">Management Information Systems</p>
              <p className="text-gray-600 mb-2">University of Technology Ho Chi Minh, Vietnam</p>
